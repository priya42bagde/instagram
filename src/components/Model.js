            ...
            <div className="model__container">
               ...
               ?<div className="model__form">
                   <form onSubmit={registerUser}>
                       ...
                       <div className="model__group">
                           <input type="password" name="password" className="model__input" placeholder="Create Password..." onChange={handleInput} value={inputs.password} required/>
                       </div>
                       <div className="model__group">
